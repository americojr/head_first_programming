...
# Se nós não transformarmos "g" em int o computador vai entender a entrada como uma letra. Dessa forma, mesmo que fosse digitado "5", o computador diria que você perder. Por que? Por que ele entende que se duas partes de informação são de "tipos" diferentes, não há nenhum mode de serem iguais.
